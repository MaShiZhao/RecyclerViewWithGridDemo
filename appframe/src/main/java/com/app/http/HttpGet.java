...
public class HttpGet
{
     ...
     */
    public HttpGet(Context context,Object object, InterfaceHttpResult listener, Class<?> className, String... params)
    {
...
//        ;mid;oauth_token;oauth_token_secret;


        LogWriter.d("httpGet mid  = " +sharedPreferencesUtil.getUid());
        LogWriter.d("httpGet oauth_token  = " +sharedPreferencesUtil.getToken());
        LogWriter.d("httpGet oauth_token_secret  = " +sharedPreferencesUtil.getTokenSecret());
        LogWriter.d("httpGet deviceId  = " +sharedPreferencesUtil.getDevicedId());
        ...
        String oauth_token = "mid="+sharedPreferencesUtil.getToken();
        String oauth_token_secret = "mid="+sharedPreferencesUtil.getTokenSecret();
    ...
    private void okHttpRequest() throws IOException
    {
        ...
        call.enqueue(new Callback()
        {
            ...
            public void onResponse(Call call, Response response) throws IOException
            {
                if (call.isCanceled())
                {
                    LogWriter.d("call is canceled");
                } else
                {
                    sendSuccessResultCallback(response);
                }
                if (HttpGet.this.objectTag != null)
                {
                    BaseActivityLifecycleCallbacks.cancelCall(HttpGet.this.objectTag.getClass(), call);
                }
            }
        });
        if (this.objectTag != null)
            ...
            mPlatform.execute(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    try
                    {
                        ...
                        LogWriter.d("ResultString"+jsonStrDes);
                        int code = 0;
                        if (jsonO.has("code"))
                        {
                        ...
                        Object bean = null;
                        if (code == BaseConstants.HTTP_CODE_1000) {
                            if(classObj!=null){
...
//        }
        ...
        LogWriter.e("请求出错："+resultString);
        mHttpResult.getCallback(requestCode, 0, resultString, null);

//        setHttpResult(0, resultString);
    }


    private void setHttpResult(int i, String resultString)
    {
//        LogWriter.d(params[0] + " resultJson : " + resultString);
//        Object bean = new Gson().fromJson(resultString, classObj);
//        mHttpResult.getCallback(requestCode, i, msg, bean);
    }
